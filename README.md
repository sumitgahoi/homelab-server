...
**Hardware (current):** existing **Intel tower** (Z270 / i5-7600K); **Intel X550-T2** — **VyOS** uses **two SR-IOV VFs** (one per port) for **WAN+LAN**; **other VMs** may use **extra VFs** each where needed; **onboard 1GbE** for **Proxmox management only**. Platform upgrade is **optional / later**.
