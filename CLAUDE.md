...
Rebuild / apply: `homelab/proxmox/README.md` (host interfaces); `homelab/vyos/setup.md` (VyOS IPv4 + WAN IPv6); `homelab/cbs350/README.md` (switch); `homelab/tailscale-india/setup.md` (India-GW, CURRENT until wg-india); `homelab/adguard/setup.md` (AdGuard, CURRENT); `homelab/wireguard/setup.md` (wg0/wg1, wg-india — PLANNED). Travel router design: `homelab/beryl.md` (PLANNED). Topology: `homelab/README.md`. Repo map: `README.md`. Do not deploy `tailscale-us`. WAN cutover is complete. WAN IPv6 on `eth1` only.
