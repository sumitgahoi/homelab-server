...
LXC on `vmbr-svc`, `10.10.0.53`, 1 vCPU / 512 MiB, SN770. Clients reach it via VyOS, not L2 on VLANs 10/20/30/40.

VyOS remains the DHCP server. AdGuard is DNS only. Later, DHCP option 6 may point appropriate clients at `10.10.0.53`. This is not an AdGuard DHCP migration.
